      ...
      <div className="h-100">
            ...
            <h4 className="section-title bg-white text-start text-primary pe-3" style={{marginTop:20,marginLeft:500}}>
              ...
              <p>Our experts collaborate with battery suppliers, fuel cell system providers, vehicle
                 ...
                 We provide knowledge, testing, inspection and certification services that ensure your
                 products meet all requirements and regulations.</p>
               <b><p>We provide those services for various components and advanced
                 energy storage devices and systems for all types of vehicles,</p></b>
                 <ul>
                    <li>Secondary batteries</li>
                    <li>Battery units</li>
                    <li>Supercapacitors</li>
                    <li>Inverters</li>
                    <li>Electric motors</li>
                    <li>Charging units</li>
                    <li>Other electric vehicle components and systems</li>
                 </ul>
    </div>
  )
}
